...
public class UserActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Intent i = getIntent();
        // Receiving the Data
        Button btnLogout=(Button) findViewById(R.id.btn_cancel);
        ...
        btnlogin.setOnClickListener(new View.OnClickListener() {
            ...
            public  void onClick(View arg0){
                ...
                if(edEmail.getText().toString().length() == 0){
                    ...
                    edPass.requestFocus();
                } else if (edEmail.getText().toString().equals("danguyen@gmail.com") && edPass.getText().toString().equals("123456789")) {
                    Intent nextScreen = new Intent(getApplicationContext(), ManagementActivity.class);
